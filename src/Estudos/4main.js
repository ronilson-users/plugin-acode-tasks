...
children: [
tag('i', { className: 'icon keyboard_arrow_down' }),
tag('span', { className: 'text-sc', textContent: 'STAGING' }),
tag('span', { className: 'cont-files', textContent: '1' }),
tag("i", {
...
tag('span', { className: 'text-sc', textContent: 'STAGED CHANGES' }),
...
id: 'staging-files',
className: 'telha-files files-area hidden ',
children: [
...
tag("span", { className: 'icon documents', onclick: (event) => {
// criar function diff
...
id: 'drop-area',
children: [
tag('span', { textContent: 'All files' }),
